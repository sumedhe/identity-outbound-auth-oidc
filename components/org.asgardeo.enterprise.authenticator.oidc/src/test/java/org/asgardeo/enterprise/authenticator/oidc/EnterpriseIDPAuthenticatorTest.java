...
@PrepareForTest({ LogFactory.class, OAuthClient.class, URL.class, FrameworkUtils.class,
                  EnterpriseIDPAuthenticatorDataHolder.class, OAuthAuthzResponse.class, OAuthClientRequest.class,
                  OAuthClientResponse.class, IdentityUtil.class, EnterpriseIDPAuthenticator.class, ServiceURLBuilder.class})
public class EnterpriseIDPAuthenticatorTest extends PowerMockTestCase {
    ...
    EnterpriseIDPAuthenticator openIDConnectAuthenticator;
    ...
    public void init() {
        ...
        openIDConnectAuthenticator = new EnterpriseIDPAuthenticator();
        ...
        authenticatorProperties.put(EnterpriseIDPAuthenticatorConstants.CLIENT_ID, "u5FIfG5xzLvBGiamoAYzzcqpBqga");
        authenticatorProperties.put(EnterpriseIDPAuthenticatorConstants.CLIENT_SECRET, "_kLtobqi08GytnypVW_Mmy1niAIa");
        authenticatorProperties.put(EnterpriseIDPAuthenticatorConstants.OAUTH2_TOKEN_URL, "https://localhost:9443/oauth2/token");
        authenticatorProperties.put(EnterpriseIDPAuthenticatorConstants.OAUTH2_AUTHZ_URL, "https://localhost:9443/oauth2/authorize");
    ...
    public void testCanHandle(String grantType, String state, String loginType, String error, String expectedCanHandler, String expectedContext, String msgCanHandler, String msgContext) throws IOException {
        ...
        when(mockServletRequest.getParameter(EnterpriseIDPAuthenticatorConstants.OAUTH2_GRANT_TYPE_CODE)).thenReturn(grantType);
        when(mockServletRequest.getParameter(EnterpriseIDPAuthenticatorConstants.OAUTH2_PARAM_STATE)).thenReturn(state);
        when(mockServletRequest.getParameter(EnterpriseIDPAuthenticatorConstants.LOGIN_TYPE)).thenReturn(loginType);
        when(mockServletRequest.getParameter(EnterpriseIDPAuthenticatorConstants.OAUTH2_ERROR)).thenReturn(error);
    ...
    public void testGetSubjectAttributes() throws OAuthSystemException,
        ...
        when(mockOAuthClientResponse.getParam(EnterpriseIDPAuthenticatorConstants.ACCESS_TOKEN)).
        ...
        openIDConnectAuthenticator = spy(EnterpriseIDPAuthenticator.class);
    ...
    public void testPassProcessAuthenticationResponse() throws Exception {
        ...
        when(enterpriseIDPAuthenticatorDataHolder.getClaimMetadataManagementService()).thenReturn
        ...
        assertEquals(mockAuthenticationContext.getProperty(EnterpriseIDPAuthenticatorConstants.ACCESS_TOKEN),
                accessToken, "Invalid access token in the authentication context.");

        assertEquals(mockAuthenticationContext.getProperty(EnterpriseIDPAuthenticatorConstants.ID_TOKEN), idToken,
    ...
    private void setupTest() throws Exception {
        ...
        when(mockAuthenticationContext.getProperty(EnterpriseIDPAuthenticatorConstants.ACCESS_TOKEN)).thenReturn(accessToken);
        when(mockAuthenticationContext.getProperty(EnterpriseIDPAuthenticatorConstants.ID_TOKEN)).thenReturn(idToken);
        setParametersForOAuthClientResponse(mockOAuthClientResponse, accessToken, idToken);
        ...
        when(enterpriseIDPAuthenticatorDataHolder.getRealmService()).thenReturn(mockRealmService);
    ...
    private void setParametersForOAuthClientResponse(OAuthClientResponse mockOAuthClientResponse,
        ...
        when(mockOAuthClientResponse.getParam(EnterpriseIDPAuthenticatorConstants.ACCESS_TOKEN)).thenReturn(accessToken);
        when(mockOAuthClientResponse.getParam(EnterpriseIDPAuthenticatorConstants.ID_TOKEN)).thenReturn(idToken);
    }
