...
import org.asgardeo.enterprise.authenticator.oidc.TestUtils;
...
import org.asgardeo.enterprise.authenticator.oidc.logout.idpinit.model.LogoutRequest;
...
import static org.asgardeo.enterprise.authenticator.oidc.util.OIDCErrorConstants.ErrorMessages.LOGOUT_TOKEN_AUD_CLAIM_VALIDATION_FAILED;
...
@PrepareForTest({ SignedJWT.class, IdentityProviderManager.class, JWTSignatureValidationUtils.class,
                  ...
                  UserSessionManagementService.class, EnterpriseIDPAuthenticatorDataHolder.class, IdentityTenantUtil.class,
...
public class FederatedIdpInitLogoutProcessorTest extends PowerMockTestCase {
    ...
    public void testOidcFederatedLogout() throws Exception {
        ...
        EnterpriseIDPAuthenticatorDataHolder enterpriseIDPAuthenticatorDataHolder =
                mock(EnterpriseIDPAuthenticatorDataHolder.class);
        ...
        when(EnterpriseIDPAuthenticatorDataHolder.getInstance().getServerSessionManagementService())
    ...
    public void testOidcFederatedLogoutWithoutSid() throws Exception {
        ...
        EnterpriseIDPAuthenticatorDataHolder enterpriseIDPAuthenticatorDataHolder =
                mock(EnterpriseIDPAuthenticatorDataHolder.class);
        when(EnterpriseIDPAuthenticatorDataHolder.getInstance()).thenReturn(enterpriseIDPAuthenticatorDataHolder);
        when(EnterpriseIDPAuthenticatorDataHolder.getInstance().getUserSessionManagementService())
